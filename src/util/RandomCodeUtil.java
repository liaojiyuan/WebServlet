...
public class RandomCodeUtil {
	...
	public static final void randomCode(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		// 4、写随机数
		String verifiedCode = drawRandomNum((Graphics2D) g);
		request.getSession().setAttribute("verifiedCode", verifiedCode);
